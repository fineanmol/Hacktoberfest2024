...
import functions_for_blackjack
...
ttk.Label(master=cardFrame, text="Player 1's Score-", style="TLabel"
          ).grid(row=2, column=0)
ttk.Label(master=cardFrame, textvariable=player1ScoreLabel,
          style="TLabel").grid(row=3, column=0)
ttk.Label(master=cardFrame2, text="Player 1's Score-", style="TLabel"
          ).grid(row=2, column=0)
ttk.Label(master=cardFrame2, textvariable=player1ScoreLabelT2,
          style="TLabel").grid(row=3, column=0)
