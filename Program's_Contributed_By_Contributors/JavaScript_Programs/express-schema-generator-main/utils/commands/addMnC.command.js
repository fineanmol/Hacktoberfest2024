...
const createRespectiveMnC = (fileName,modelData, controllerData) => { 
    ...
    fs.writeFile(`src/controllers/${fileName}.controller.js`,controllerData,(err, data) => {catchErr(err, 'writeControllerFile')})
...
module.exports=(modelArr)=>{ getFullCode(modelArr) }