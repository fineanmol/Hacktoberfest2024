public class DoublyLinkedList <T> implements Iterable <T> {
  ...
  public void clear() {   // Deallocates memory
    Node <T> trav = head;
    while(trav != null) {
...
// Add an element to the tail of thelinked lists, O(1)
  public void add(Telem){
    addLast(elem);
  }
 ...
 // Add a node to the tail of the linked list, O(1)
  public void addLast( T elem) {
    ...
    if (isEmpty()){
     ...
     tail.prev = new Node <T> (elem , tail , null );
     tail = tail.prev;
   }
   size++;
  }
...
//Remove the first value at the head of the linked list, O(1)
  public T removeFirst() {
    ...
    if( isEmpty()) throw new RuntimeExceptiion("Empty List");
    
    //Extract the data at the head & move the head pointer forwards one node
    T data = head.data;
    head = head.next;
    --size;
  ...
  //Remove the last value at the head of the linked list, O(1)
  public T removeLast() {
    // Can't remove data from an empty list
    if( isEmpty()) throw new RuntimeExceptiion("Empty List");
    
    //Extract the data at the tail & move the tail pointer backwards one node
    T data = tail.data;
    tail = tail.prev;
    --size;
  ...
  public T removeAt(int index) {
    //Make sure the index provided is valis
