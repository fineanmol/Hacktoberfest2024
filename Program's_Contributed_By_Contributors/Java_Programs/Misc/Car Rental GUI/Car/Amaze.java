...
public class Amaze {
    public void amazeDet(){
        JFrame f = new JFrame("Amaze");
        ...
        f.add(l1);
        JLabel l2=new JLabel("Automatic");
