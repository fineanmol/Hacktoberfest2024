...
class GUI():
    ...
    def loginscreen(self):
        ...
        def hide(event):
            ...
            self.password = Entry(self.authlogin,textvariable = passwordentry,bg = 'grey',fg = 'white',\
                            font = ('Operator Mono', 16 ,'bold'),show = '*',width = '15')
            self.password.place(x=241,y=241)
        ...
        self.username = Entry(self.authlogin,textvariable = usernameentry,bg = 'grey',fg = 'white',\
                        font = ('Operator Mono', 16 ,'bold'),show = '',width = '15')
        self.username.place(x=241,y=171)
        ...
        self.labelackn.place(x=260,y=395)
    ...
    def library(self):
        ...
        self.label_entry = Label(self.window,text='Welcome to Library Database Management System',\
                           fg='blue',bg='white',relief = ('solid'),font = ('Arial',19,'bold'))
        ...
        self.button1 = Button(self.window,text='VIEW ALL RECORDS',fg='black',bg='white',relief = ('sunken'),\
                       font = ('Operator Mono',16,'bold'),command=opencsv)
        self.button1.pack(fill=BOTH,padx=220,pady=5)



        self.button2 = Button(self.window,text='ADD NEW RECORD',fg='black',bg='white',relief = ('sunken'),\
                       font = ('Operator Mono',16,'bold'),command=self.adding)
        self.button2.pack(fill=BOTH,padx=220,pady=5)


        self.button4 = Button(self.window,text='UPDATE A RECORD',fg='black',bg='white',relief = ('sunken'),\
                       font = ('Operator Mono',16,'bold'),command=self.updating)
        self.button4.pack(fill=BOTH,padx=220,pady=5)


        self.button5 = Button(self.window,text='RETURN A BOOK',fg='black',bg='white',relief = ('sunken'),\
                       font = ('Operator Mono',16,'bold'),command=self.deletingparticular)
        self.button5.pack(fill=BOTH,padx=220,pady=5)


        self.button6 = Button(self.window,text='DELETE ALL RECORDS',fg='black',bg='white',relief = ('sunken'),\
                       font = ('Operator Mono',16,'bold'),command=self.deletingall)
        self.button6.pack(fill=BOTH,padx=220,pady=5)


        self.button7 = Button(self.window,text='EXIT',fg='black',bg='white',relief = ('sunken'),\
                       font = ('Operator Mono',16,'bold'),command=exitout)
        self.button7.pack(fill=BOTH,padx=470,pady=5)


        self.labelackn = Label(self.window,text='Designed and Developed by: KANDARP SOLANKI',fg='black',\
                         bg='deeppink',font = ('Operator Mono Medium',13,'italic'))
        self.labelackn.place(x=614,y=574)
        ...
        self.label_caution.pack(fill=BOTH,padx=180,pady=10)
    ...
    def homepge(self):
        ...
        self.but_lib = Button(self.homepage,image = photo,command = self.library,borderwidth=1,relief='solid')
        ...
        self.but_app1 = Button(self.homepage,image = photo2,borderwidth=1,relief='solid')
        ...
        self.but_app2 = Button(self.homepage,image = photo3,borderwidth=1,relief='solid')
        ...
        self.but_app3 = Button(self.homepage,image = photo4,borderwidth=1,relief='solid')
        ...
        self.but_app4 = Button(self.homepage,image = photo5,borderwidth=1,relief='solid')
        ...
        self.but_app5 = Button(self.homepage,image = photo6,borderwidth=1,relief='solid')
        self.but_app5.place(x=425,y=420)

        self.logout = Button(self.homepage,text = 'Logout',bg = 'white',command = logout,\
                      borderwidth=2,height = 1,width = 5,font = ('Arial',15)) 
        self.logout.place(x=933,y=114)

        self.labelackn = Label(self.homepage,text='Designed and Developed by: KANDARP SOLANKI',fg='black',\
                         bg='deeppink',font = ('Operator Mono Medium',13,'italic'))
        self.labelackn.place(x=608,y=574)
    ...
    def adding(self):
        ...
        self.namelabel = Label(self.add,text = 'Student Name :',bg = 'deeppink',font = ('Arial 16 bold'))
        self.namelabel.place(x=200,y=200)
        self.stu_name = Entry(self.add,textvariable = name,font = ('Arial 16 italic'))
        self.stu_name.place(x=500,y=200)


        self.rolllabel = Label(self.add,text = 'Examination Seat No :',bg = 'deeppink',font = ('Arial 16 bold'))
        self.rolllabel.place(x=200,y=240)
        self.stu_roll = Entry(self.add,textvariable = roll,font = ('Arial 16 italic'))
        self.stu_roll.place(x=500,y=240)

        self.isbnlabel = Label(self.add,text = 'ISBN No. :',bg = 'deeppink',font = ('Arial 16 bold'))
        self.isbnlabel.place(x=200,y=280)
        self.stu_isbn = Entry(self.add,textvariable = isbn,font = ('Arial 16 italic'))
        self.stu_isbn.place(x=500,y=280)
    
        self.booklabel = Label(self.add,text = 'Book Name :',bg = 'deeppink',font = ('Arial 16 bold'))
        self.booklabel.place(x=200,y=320)
        self.stu_book = Entry(self.add,textvariable = book,font = ('Arial 16 italic'))
        ...
        self.tbut = Button(self.add,text = 'Add',command = printt,width = 5,height = 1,font = ('Arial 16 bold'))
        self.tbut.place(x=450,y=400)
    ...
    def updating(self):
                ...
                if exseatno not in list_checknames:
                    ...
                    if user_choose == 'N':
                        self.newlabel = Label(self.updat, text = 'Enter updated name :                ',\
                                        bg = 'deeppink',font = ('Arial 16 bold'))
                        self.newlabel.place(x=150,y=450)
                        self.newlabelentry = Entry(self.updat,textvariable = updainfo,font = ('Arial 16 italic'))
                        self.newlabelentry.place(x=500,y=450)
                        self.tbutupd = Button(self.updat,text = 'Update',command = updateahead,width = 6,\
                                       height = 1,font = ('Arial 16 bold') )
                        self.tbutupd.place(x=450,y=500)
                    elif user_choose == 'E':
        ...
        self.stu_es = Entry(self.updat,textvariable = exseat,font = ('Arial 14 italic'))
        self.stu_es.place(x=600,y=203)
        ...
        self.infolabel = Label(self.updat,text = '*Press CHOOSE to enter the updated information',\
                         bg = 'deeppink',font = ('Arial 16 italic'))
        self.infolabel.place(x=265,y=410)

        self.labelackn = Label(self.updat,text='Designed and Developed by: KANDARP SOLANKI',fg='black',\
                         bg='deeppink',font = ('Operator Mono Medium',13,'italic'))
        self.labelackn.place(x=613,y=574)
    ...
    def deletingparticular(self):
        ...
        self.isbnentry = Entry(self.delpar,textvariable = isbnreturn,font = ('Arial 16 italic'))
        self.isbnentry.place(x=600,y=200)

        self.butdel = Button(self.delpar,text = 'DELETE',command = delparcmd,width = 9,height = 1,\
                      font = ('Arial 16 bold') )
        self.butdel.place(x=430,y=350)

        self.labelackn = Label(self.delpar,text='Designed and Developed by: KANDARP SOLANKI',fg='black',\
                         bg='deeppink',font = ('Operator Mono Medium',13,'italic'))
        self.labelackn.place(x=619,y=574)
