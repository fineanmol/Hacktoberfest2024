...
class calc:
    ...
    def __init__(self, master):
        ...
        master.geometry()
        master.configure(bg="#111418")
        self.e = Entry(master)
        self.e.grid(row=0, column=0, columnspan=6, pady=3)
        self.e.focus_set()  # Sets focus on the input text area

        # Generating Buttons
        Button(master, text="=", width=11, height=3, fg="#11A89D",
               bg="#111418", relief="flat", borderwidth=0, activebackground="#111418", command=lambda: self.equals()).grid(
            row=4, column=4, columnspan=2)

        Button(master, text='AC', width=5, height=3,
               fg="#11A89D",
               bg="#111418", relief="flat", borderwidth=0, activebackground="#111418",
